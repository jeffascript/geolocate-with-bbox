...
import { ConvertedFeature } from '@Jeff/shared';
...
export const setOneFeatureToStore = (id: string) => {
    return async (dispatch: AppDispatch, getState: () => RootState) => {
        ...
        try {
            ...
            const oneFound = rootState.allFeatures.featureStore.respData.features.filter((el) => el.id === id);
...
export const { fetchOneFeaturePending, fetchOneFeatureFailure, fetchOneFeatureSuccess, clearOneFeatureData } =
    oneFeature.actions;
